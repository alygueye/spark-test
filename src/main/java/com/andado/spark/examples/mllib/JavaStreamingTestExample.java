 ...
 *
 * The rows of the text files must be in the form `Boolean, Double`. For example: false, -3.92 true,
 * 99.32
 *
 * Usage: JavaStreamingTestExample <dataDir> <batchDuration> <numBatchesTimeout>
 *
 * To run on your local machine using the directory `dataDir` with 5 seconds between each batch and
 * a timeout after 100 insignificant batches, call: $ bin/run-example mllib.JavaStreamingTestExample
 * dataDir 5 100
 *
