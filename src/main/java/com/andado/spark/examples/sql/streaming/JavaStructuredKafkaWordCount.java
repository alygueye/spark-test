 ...
 * JavaStructuredKafkaWordCount <bootstrap-servers> <subscribe-type> <topics> <bootstrap-servers>
 * The Kafka "bootstrap.servers" configuration. A comma-separated list of host:port.
 ...
 * <subscribePattern> The pattern used to subscribe to topic(s). |  Java regex string. |- Only one
 * of "assign, "subscribe" or "subscribePattern" options can be |  specified for Kafka source.
 * <topics> Different value format depends on the value of 'subscribe-type'.
 *
 * Example: `$ bin/run-example \ sql.streaming.JavaStructuredKafkaWordCount host1:port1,host2:port2
